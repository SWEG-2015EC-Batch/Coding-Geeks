...
// b.Function to count the number of digits in a number
...
// c.Function to find the sum of digits in a number
...
// d.Function to find the product of even digits in a number
...
// e.Function to find the first and last digit and their sum
...
// f.Function to swap the first and last digit
...
// g.Function to check if a number is palindrome or not
bool isPalindrome(int num) {
    return num == reverseNumber(num);
}

// h.Function to find the frequency of each digit
...
// i.Function to check if a number is Armstrong or not 
...
// j.Function to check if a number is Strong or not 
...
// k.Function to check if a number is Perfect or not.
